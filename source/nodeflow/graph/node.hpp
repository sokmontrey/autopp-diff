...
protected:
  ...
  void setCols(size_t cols) { this->cols = cols; }
...
public:
  ...
  Eigen::MatrixXd &operator()() { return this->value; }
  double &operator()(size_t row, size_t col) { return this->value(row, col); }
  double getValue(size_t row, size_t col) { return this->value(row, col); }
  double getValue() { return this->value(0, 0); }
  Eigen::MatrixXd &getMatrix() { return this->value; }
  Eigen::MatrixXd &getGrad() {
    if (!this->is_differentiatable)
      std::cout << "Warning: Calling 'getGrad()' on a constant node"
                << std::endl;
  ...
  void setValue(double new_value) { this->value(0, 0) = new_value; }
  ...
  bool isDifferentiatable() { return this->is_differentiatable; }
  bool isConstant() { return this->is_constant; }
  Node &constant() {
  ...
  virtual void finished() { this->finished(true); }
  ...
  virtual Eigen::MatrixXd &forward() { return this->value; }
  ...
  static Node Random() { return Node(Eigen::MatrixXd::Random(1, 1)); }
...
public:
  ...
  Eigen::MatrixXd getInput() { return this->inputs[0]->getMatrix(); }
